...
class Pipeline(object):
    ...
    def fit(self):
        ...
        callback.append(ModelCheckpoint(
            filepath=r"C:\Users\86150\Desktop\COSMIC数据\moxing\moxing7" +
                     "/" + 'finetune_model_{epoch:04d}_{val_f1:.04f}_{val_re:.04f}_{val_prec:.04f}_{val_loss:.04f}_{val_accuracy:.04f}_1.hdf5',
            monitor='val_f1', verbose=1, save_best_only=True, mode='max'))

        callback.append(ModelCheckpoint(
            filepath=r"C:\Users\86150\Desktop\COSMIC数据\moxing\moxing7\final_model.hdf5",
            verbose=1,
        ...
        # === 加载预训练模型 ===
        pretrained_path = r"C:\Users\86150\Desktop\COSMIC数据\moxing\moxing1\model_0046_0.7787_0.8446_0.7486_0.0111_0.9963_1.hdf5"
        ...
        history = model.fit(train_data.__iter__(), epochs=self.epoch, steps_per_epoch=300,
    ...
    def test(self, ):
        ...
        model = tf.keras.models.load_model(
            r"C:\Users\86150\Desktop\COSMIC数据\moxing\moxing1\model_0046_0.7787_0.8446_0.7486_0.0111_0.9963_1.hdf5",
            custom_objects={'f1': f1, 're': re,
                            'prec': prec})

        print('--' * 20)

        X_test = np.load(r"C:\Users\86150\Desktop\COSMIC数据\ROC_x.npy", allow_pickle=True).astype(
            np.float32)
        Y_test = np.load(r"C:\Users\86150\Desktop\COSMIC数据\ROC_y.npy", allow_pickle=True).astype(
            np.float32)
        ...
        np.save(r"C:\Users\86150\Desktop\COSMIC数据\unet_2003new_y_19.npy", pre_label)
